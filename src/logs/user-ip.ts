...
Privacy Policy
At enigma, accessible from enigma, one of our main priorities is the privacy of our visitors. 
This Privacy Policy document contains types of information that is collected and recorded by enigma and how we use it.
...
information that they shared and/or collect in enigma. This policy is not applicable to any information 
...
Log Files
enigma follows a standard procedure of using log files. These files log visitors when they visit websites. 
...
Like any other website, enigma uses 'cookies'. These cookies are used to store information including visitors' preferences, 
...
You may consult this list to find the Privacy Policy for each of the advertising partners of enigma.

Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in their 
respective advertisements and links that appear on enigma, which are sent directly to users' browser. 
...
Note that enigma has no access to or control over these cookies that are used by third-party advertisers.

Third Party Privacy Policies
enigma's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the 
...
enigma does not knowingly collect any Personal Identifiable Information from children under the age of 13. 
...
// Change tsconfig to esnext and use high level await.
